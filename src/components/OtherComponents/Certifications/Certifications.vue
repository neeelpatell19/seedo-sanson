...
import { Navigation, Pagination, A11y, Autoplay } from "swiper/modules"; // for Swiper v10/v11
// If you're on Swiper v8/9, use: import { Navigation, Pagination, A11y } from "swiper";
